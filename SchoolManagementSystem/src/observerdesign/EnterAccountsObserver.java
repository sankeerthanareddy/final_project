...
public class EnterAccountsObserver extends AccountsObserver {
    public EnterAccountsObserver(Accounts accounts){
    ...
    public void update() {
        try{
            ...
            String name= "AccountsData.txt";                  //variable name to store the file name  
            ...
            System.out.print("Enter Staff/Teacher/Student Salary or Fees: ");
